...
CKFinder.lang['zh-cn'] =
{
	...
	common :
	{
		...
		confirmCancel	: '部分内容尚未保存，确定关闭对话框？',
		ok				: '确定',
		cancel			: '取消',
	...
	FileRenaming	: '正在重命名...',
	FileDelete		: '您确定要删除 "%1" 个文件吗？',
	FilesDelete	: '您确定要删除文件 "%1" 吗？', // MISSING
	FilesLoading	: '加载中...',
	FilesEmpty		: '空文件夹',
	DestinationFile	: '目标文件', // MISSING
	SkippedFiles	: '跳过文件列表:', // MISSING
	...
	BasketRemoveConfirmMultiple	: '确定将 "%1" 从该文件夹删除？', // MISSING
	...
	OperationCompletedErrors		: '操作异常。', // MISSING
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	MovedFilesNumber		: '移动文件数量: %s。', // MISSING
	CopiedFilesNumber	: '复制文件数量: %s。', // MISSING
	MoveFailedList		: '不能被移动的文件有:<br />%s', // MISSING
	CopyFailedList		: '不能被复制的文件有:<br />%s', // MISSING
	...
	Zip :
	{
		extractHereLabel	: '解压', // MISSING
		extractToLabel		: '解压到...', // MISSING
		downloadZipLabel	: '下载zip', // MISSING
		compressZipLabel	: '压缩到zip', // MISSING
		removeAndExtract	: '解压后删除', // MISSING
		extractAndOverwrite	: '解压并覆盖当前文件夹', // MISSING
